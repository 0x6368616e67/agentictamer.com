...
export const tiers = [
  ...
  },
  {
    ...
    tagline: '协助实现您的想法',
    role: '技术骨干',
    position: '作为您的技术朋友，协助您的技术团队一起实现您的想法和需求。',
...
export const clauses = [
  {
    Icon: IconShield,
    title: '知识产权归属',
    body: '约定服务期间产出的代码、文档等知识产权，在客户全额支付后归客户所有。',
  },
  {
    Icon: IconLock,
    title: '保密与竞业',
    body: '可签署 NDA，但限制竞业范围（如禁止服务期内同时为直接竞品提供相同档位服务）。',
  },
  {
    Icon: IconScale,
    title: '责任上限',
  ...
  },
  {
    Icon: IconDoor,
    title: '终止条款',
    body: '双方可提前 14 天书面通知终止，但已支付款项不退，未开始的服务期按比例结算。',
  },
]
